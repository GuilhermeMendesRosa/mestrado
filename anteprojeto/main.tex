...
\title{Tradução de Linguagem Natural para Comandos Robóticos:\\
Uma Abordagem Baseada em Transformers para a LBML}

\author{Guilherme Mendes Rosa\inst{1}}

\address{Programa de Pós-Graduação em Computação Aplicada -- PPGCA\\
  Universidade do Estado de Santa Catarina -- UDESC
  \email{guilherme.mr@edu.udesc.br}
}
...
\begin{resumo}
Este anteprojeto propõe investigar a tradução automática de comandos em português para uma linguagem de domínio específico voltada à movimentação robótica, denominada LBot Movement Language (LBML). O trabalho visa desenvolver um simulador web que permita interação por linguagem natural, constituir um dataset curado de comandos textuais e suas representações formais, e analisar a eficácia de modelos baseados em Transformers na tradução para linguagens de comando robótico. A abordagem combina dados sintéticos e reais, buscando criar um modelo especializado e compacto adequado para operação em ambientes com recursos limitados. A avaliação diferenciará erros sintáticos de semânticos, contribuindo para tornar sistemas robóticos mais acessíveis e intuitivos.
\end{resumo}
...
\ganttbar{Redação da dissertação}{18}{36} \\
